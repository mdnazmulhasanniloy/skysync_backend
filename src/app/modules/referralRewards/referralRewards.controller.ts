...
const getAllReferralRewards = catchAsync(async (req: Request, res: Response) => {
...
const getReferralRewardsById = catchAsync(async (req: Request, res: Response) => {
 const result = await referralRewardsService.getReferralRewardsById(req.params.id);
  sendResponse(res, {
    statusCode: 200,
    success: true,
...
const deleteReferralRewards = catchAsync(async (req: Request, res: Response) => {
 const result = await referralRewardsService.deleteReferralRewards(req.params.id);
  sendResponse(res, {
    statusCode: 200,
    success: true,
