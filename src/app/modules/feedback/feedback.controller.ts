...
const adminResponse = catchAsync(async (req: Request, res: Response) => {
  const result = await feedbackService.adminResponse(req.params.id, req.body);
  sendResponse(res, {
    statusCode: 200,
    success: true,
    message: 'admin response send successfully',
    data: result,
  });
});
